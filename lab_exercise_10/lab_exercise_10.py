...
def main():
    ...
    Return:
        None
    '''
    # Call < get_resource() > with the correct parameters and save results to < vader_data >

    # Retrieve Darth Vaders's species and assign to < vader_species >

    # Create an instance of < Person > using the data you have stored in < vader_data >
